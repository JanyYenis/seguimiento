        ...
        <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
            ...
            <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                ...
                <form class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate"
                    id="kt_sign_up_form" data-kt-redirect-url="/metronic8/demo52/authentication/layouts/overlay/sign-in.html"
                    action="#">
                    <!--begin::Heading-->
                    ...
                    <div class="row g-3 mb-9">
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="#"
                                ...
                                <img alt="Logo" src="/metronic8/demo52/assets/media/svg/brand-logos/google-icon.svg"
                                    class="h-15px me-3">
                                Sign in with Google
                            </a>
                            <!--end::Google link--->
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="#"
                                class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
                                <img alt="Logo" src="/metronic8/demo52/assets/media/svg/brand-logos/apple-black.svg"
                                    class="theme-light-show h-15px me-3">
                                <img alt="Logo"
                                    src="/metronic8/demo52/assets/media/svg/brand-logos/apple-black-dark.svg"
                    ...
                    <!--begin::Separator-->
                    <div class="separator separator-content my-14"><span class="w-125px text-gray-500 fw-semibold fs-7">Or
                            with
                            email</span></div>
                    <!--end::Separator-->
                            ...
                            <div class="position-relative mb-3">
                                ...
                                <span class="btn btn-sm btn-icon position-absolute translate-middle top-50 end-0 me-n2"
                                    ...
                                    <i class="ki-outline ki-eye-slash fs-2"></i> <i
                                        class="ki-outline ki-eye fs-2 d-none"></i>
                                </span>
                            </div>
                            <!--end::Input wrapper-->
                    ...
                    <div class="text-gray-500 text-center fw-semibold fs-6">
                        ...
                        <a href="/metronic8/demo52/authentication/layouts/overlay/sign-in.html"
