    ...
    <div class="card-header bgi-position-y-bottom bgi-position-x-end bgi-size-cover bgi-no-repeat rounded-0 border-0 py-4"
        ...
        <div class="card-toolbar">
            <button type="button" class="btn btn-sm btn-icon btn-color-white p-0 w-20px h-20px rounded-1"
                ...
                <i class="las la-times fs-1"></i> </button>
        </div>
        <!--end::Card toolbar-->
    </div>
    <!--end::Card header-->
    ...
    <div class="card-body position-relative" id="kt_app_layout_builder_body">
        ...
        <div id="kt_app_settings_content" class="position-relative scroll-y me-n5 pe-5"
            ...
            <form class="form" method="POST" id="kt_app_layout_builder_form"
                action="/metronic8/demo52/index.php">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="form-group d-flex flex-stack">
                        <!--begin::Heading-->
                        <div class="d-flex flex-column">
                            <h4 class="fw-bold text-gray-900">Sidebar Panel</h4>
                            <div class="fs-7 fw-semibold text-muted">
                                Display sidebar penel.

                                <a href="/metronic8/demo52/layout-builder.html"
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <div
                                ...
                                <input type="hidden" value="false"
                                    name="layout-builder[layout][app][sidebar-panel][display]">
                                <input class="form-check-input w-45px h-30px" type="checkbox"
                                    value="true"
                                    name="layout-builder[layout][app][sidebar-panel][display]"
                                    id="kt_builder_aside">
...
data-bs-dismiss="click" data-bs-trigger="hover" data-bs-original-title="Configuración"
data-kt-initialized="1">
