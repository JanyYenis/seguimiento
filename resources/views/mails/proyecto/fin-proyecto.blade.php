    ...
    <td align="left" valign="center">
        <div style="text-align:left; margin: 0 20px; padding: 40px; background-color:#ffffff; border-radius: 6px">
            ...
            <div style="padding-bottom: 30px">
                Nos complace informarte que el proyecto {{$proyecto->nombre}} ha sido finalizado con éxito.
            </div>
            <div style="padding-bottom: 30px">
                Gracias por tu esfuerzo y dedicación para alcanzar este logro. Puedes revisar los detalles finales y dejar tus comentarios siguiendo el enlace a continuación:
            </div>
