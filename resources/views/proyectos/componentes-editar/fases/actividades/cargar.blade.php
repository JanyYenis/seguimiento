...
<div class="modal fade" tabindex="-1" id="modalCargarArchivoActividades">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="cargarArchivoActividades" enctype="multipart/form-data" class="dropzone">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary-gijac-modal" id="enviarButtonActividades">Cargar</button>
            </div>
        </div>
    </div>
</div>