<div>
    <div class="modal fade" id="modalEditarFase" tabindex="-1" aria-hidden="true">
        <input type="hidden" name="idFase" id="idActividad">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y pt-10 pb-15 px-lg-17">
                    <form id="formEditarFase" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
                        <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                            ...
                            <input type="text" class="form-control form-control-solid" placeholder="Titulo de la fase"
                                name="titulo" id="tituloFase" required>
                            <div
                        ...
                        <div class="d-flex flex-column mb-8">
                            ...
                            <textarea class="form-control form-control-solid" rows="3" name="descripcion" id="descripcionFase"
